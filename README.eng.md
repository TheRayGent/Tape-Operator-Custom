...
3. Install the script by going to [this link](https://github.com/TheRayGent/Tape-Operator-Custom/blob/main/userscript/tape-operator.user.js). _(or download `tape-operator.user.js` from folder `userscript`) and install manually)_
